...
namespace EldritchArcana
{
    ...
    static class MetamagicFeats
    {
        ...
        internal static IEnumerable<BlueprintFeature> CreateMetamagicFeats()
        {
            ...
            feats.Add(CreateMetamagicFeat(
                ModMetamagic.Toppling, "566739fdc0e2417f9165b72bab7ba421", Main.lc.GetTranslate("Metamagic.ftTopplingName"),
                Main.lc.GetTranslate("Metamagic.ftTopplingDesc"),
            ...
            feats.Add(persistentSpellFeat = CreateMetamagicFeat(
                ModMetamagic.Persistent, "fd0df5bbcadb4a5abb3d3030aeceb9a9", Main.lc.GetTranslate("Metamagic.ftPersistentName"),
                Main.lc.GetTranslate("Metamagic.ftPersistentDesc"),
                /*SpellFocusIllusion*/
            ...
            feats.Add(CreateMetamagicFeat(
                ModMetamagic.Selective, "7b6cf55779314114aa85e1b1577e94bf", Main.lc.GetTranslate("Metamagic.ftSelectiveName"),
                Main.lc.GetTranslate("Metamagic.ftSelectiveDesc"),
            ...
            var elementalSpellFeat = Helpers.CreateFeatureSelection(
                ...
                Main.lc.GetTranslate("Metamagic.ftElementalName"),
                Main.lc.GetTranslate("Metamagic.ftElementalDesc"),
